...
- **Timed IP bans** – `/ban-ip <address-or-player> <duration> <reason>` (alias `/banip`) bans a literal address, or both the account and current address when targeting an online player
