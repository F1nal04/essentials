...
class InventoryViewLayoutTest {
    ...
    void spotChecksMatchTheIntendedLayout() {
        ...
        assertEquals(0, InventoryViewLayout.mapSlot(27));   // hotbar row starts
        assertEquals(8, InventoryViewLayout.mapSlot(35));   // hotbar row ends
        assertEquals(39, InventoryViewLayout.mapSlot(36));  // helmet
        assertEquals(38, InventoryViewLayout.mapSlot(37));  // chestplate
        assertEquals(37, InventoryViewLayout.mapSlot(38));  // leggings
        assertEquals(36, InventoryViewLayout.mapSlot(39));  // boots
        assertEquals(40, InventoryViewLayout.mapSlot(40));  // offhand
        assertEquals(InventoryViewLayout.LOCKED, InventoryViewLayout.mapSlot(41));
        assertEquals(InventoryViewLayout.LOCKED, InventoryViewLayout.mapSlot(44));
    }

    @Test
    void outOfRangeThrows() {
        assertThrows(IllegalArgumentException.class, () -> InventoryViewLayout.mapSlot(-1));
        assertThrows(IllegalArgumentException.class, () -> InventoryViewLayout.mapSlot(45));
    }
}
